...
class RRU_IO extends Bundle {
    ...
    val o_rn1 = Output(UInt((params.Parameters.PLogNumReg).W))  //Read Register No-1
    val o_rn2 = Output(UInt((params.Parameters.PLogNumReg).W))  //Read Register No-2
    val o_wno = Output(UInt((params.Parameters.PLogNumReg).W))  //Write Register No
    ...
    val i_wbn = Input( UInt((params.Parameters.PLogNumReg).W))  //Write-Back No.
